 ...
 * when the call to the DB completes
 */
function create(consumerID,usage,timestamp) {
    return listsDaoImpl.create(consumerID,usage,timestamp);
}
 ...
 * when the call to the DB completes
 */
function update(id, consumerID) {
    return listsDaoImpl.update(id, consumerID);
}
